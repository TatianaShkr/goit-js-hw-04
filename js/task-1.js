...
function isEnoughCapacity(products, containerSize) {
  ...
  const nameProducts = Object.keys(products);
  for (const product of nameProducts) {
    // console.log(product);
  }
  const kolProducts = Object.values(products);
  for (const kolProduct of kolProducts) {
    //console.log(kolProduct);
    totalSize += kolProduct;
  }
